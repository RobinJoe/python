...
if __name__ == '__main__':
    auth = fetchauth()
    parser = argparse.ArgumentParser(prog="bugs",
    ...
    group.add_argument('-u', '--user', action='store_true',
                       help='''Show authenticated user''')
    group.add_argument('-o', '--org', action='store_true',
                       help='''Show all orgs for authenticated user''')
